...
var VeildClient = class {
  constructor(config = {}) {
    this.chain = config.chain ?? chains.celo;
...
exports.VEILD_MESSAGES_ABI = VEILD_MESSAGES_ABI;
exports.VEILD_REGISTRY_ABI = VEILD_REGISTRY_ABI;
exports.VeildClient = VeildClient;
exports.createReadonlyClient = createReadonlyClient;
exports.createTestnetClient = createTestnetClient;
exports.getAddresses = getAddresses;
exports.veildMessages = veildMessages;
exports.veildRegistry = veildRegistry;
